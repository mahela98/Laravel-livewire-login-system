{{-- <div>
    ...
    <form wire:submit.prevent="saveMessage">
        ...
        <div>
            <textarea wire:model.lazy="message" name="message" id="" cols="30" placeholder="Message"
                rows="10"></textarea>
            @error('message')
            <div class="block w-full" style="color: red">{{$message}}</div>
            @enderror
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <textarea id="message" wire:model.lazy="message" name="message"
                        ...
                        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
                            <a class="text-green-400">Email@email.com</a>
                            <br>
                            <br>
